...
public class Facade implements IFacade {
	...
	protected static Map<String, org.puremvc.java.multicore.patterns.facade.Facade> instanceMap = new HashMap<String, org.puremvc.java.multicore.patterns.facade.Facade>();
	...
	protected void init( String key ) {
		if( instanceMap.get( key ) != null ) { throw new RuntimeException( key + " Facade already constructed" ); }
	 ...
	 */
	public synchronized static org.puremvc.java.multicore.patterns.facade.Facade getInstance( String key ) {
		if( instanceMap.get( key ) == null ) {
			try {
				new org.puremvc.java.multicore.patterns.facade.Facade( key );
			} catch( Exception e ) {
			}
		}
