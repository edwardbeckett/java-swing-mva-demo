...
public class View implements IView {
	...
	protected static Map<String, org.puremvc.java.multicore.core.view.View> instanceMap = new HashMap<String, org.puremvc.java.multicore.core.view.View>();
	 ...
	 */
	public synchronized static org.puremvc.java.multicore.core.view.View getInstance( String key ) {
		if( instanceMap.get( key ) == null ) {
			new org.puremvc.java.multicore.core.view.View( key );
		}
	...
	public void notifyObservers( INotification note ) {
		List<IObserver> observers_ref = this.observerMap.get( note.getName() );
		if( observers_ref != null ) {
			// Copy observers from reference array to working array,
			// since the reference array may change during the
			//notification loop
			Object[] observers = observers_ref.toArray();
