 ...
 * registrations.
 *
 * @see org.puremvc.java.multicore.core.view.View View
...
public class Controller implements IController {
	...
	protected static Map<String, Controller> instanceMap = new HashMap<String, org.puremvc.java.multicore.core.controller.Controller>();
	 ...
	 *
	 * @exception Error Error if instance for this Multiton key has already been constructed
	 */
	 ...
	 */
	public synchronized static org.puremvc.java.multicore.core.controller.Controller getInstance( String key ) {
		if( instanceMap.get( key ) == null ) {
			new org.puremvc.java.multicore.core.controller.Controller( key );
		}
	...
	public void executeCommand( INotification note ) {
		...
		ICommand commandInstance = this.commandMap.get( note.getName() );
	 ...
	 * @param command          an instance of <code>ICommand</code>
	 */
