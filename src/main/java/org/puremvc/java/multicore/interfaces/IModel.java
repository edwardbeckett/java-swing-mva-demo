...
public interface IModel {
	 ...
	 */
	void registerProxy( org.puremvc.java.multicore.interfaces.IProxy proxy );
	 ...
	 */
	org.puremvc.java.multicore.interfaces.IProxy retrieveProxy( String proxy );

	/**
	 * Remove an <code>IProxy</code> instance from the Model.
	 *
	 * @param proxy name of the <code>IProxy</code> instance to be removed.
	 */
